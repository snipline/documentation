...
var SearchComponent = function SearchComponent() {
    ...
    return {
        view: function view() {
            return [(0, _mithril2.default)("div.search--wrapper", [(0, _mithril2.default)("clr-icon[shape=search]"), (0, _mithril2.default)("input#search[name=search][type=search]", { value: query, oninput: function oninput(e) {
